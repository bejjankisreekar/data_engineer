...
Finding any row among 100 million takes **3–4 page reads** instead of millions. This is why point lookups are milliseconds. (Deep dive: [11_SQL_Indexes.md](../01_SQL/11_SQL_Indexes.md).)
