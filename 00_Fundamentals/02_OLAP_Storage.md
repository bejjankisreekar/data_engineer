...
See [ETL vs ELT](../05_ETL_ELT) and [01_Data_Lake_vs_Warehouse_vs_Database.md](../04_Data_Storage/01_Data_Lake_vs_Warehouse_vs_Database.md) for how data travels from OLTP to OLAP.
