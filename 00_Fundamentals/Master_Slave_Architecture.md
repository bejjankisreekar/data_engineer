...
A design pattern for [distributed systems](Distributed_Computing.md): **one node coordinates** (the master), and **many nodes do the actual work** (the slaves/workers).
...
|---|---|---|
| HDFS ([Hadoop storage](Hadoop_Architecture.md)) | NameNode | DataNodes |
