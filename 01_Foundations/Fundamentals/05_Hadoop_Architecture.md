...
YARN made Hadoop a general platform: MapReduce, [Spark](../../06_Programming/PySpark/Spark_Architecture.md), Hive and others can all run on the same cluster, sharing resources.
...
**The catch:** MapReduce writes results **to disk after every stage**. A multi-step job = read disk, process, write disk, repeat. Reliable, but *slow* — this weakness is exactly what Spark fixed (see [Why_Spark_Why_Databricks.md](../../06_Programming/PySpark/Why_Spark_Why_Databricks.md)).
...
- HDFS → cloud data lakes ([Azure Data Lake Storage](../../04_Storage_and_Formats/Data_Storage/03_Azure_Data_Lake_Storage.md), S3)
- MapReduce → [Spark](../../06_Programming/PySpark/What_Is_Apache_Spark.md)
...
|---|---|
| HDFS data | [ADLS Gen2](../../04_Storage_and_Formats/Data_Storage/03_Azure_Data_Lake_Storage.md) (distcp/ADF copy) |
| Hive tables | Delta tables + Unity Catalog |
| MapReduce/Hive jobs | Spark on [Databricks](../../06_Programming/PySpark/Why_Spark_Why_Databricks.md) (Hive SQL ports ~90% cleanly to Spark SQL) |
| Oozie workflows | [Data Factory](../../05_Data_Engineering/ETL_ELT/02_Azure_Data_Factory.md) / Databricks Workflows |
