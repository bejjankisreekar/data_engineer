...
- **Data mesh** (organizational, not technical) — domain teams own their data as *products* with contracts, instead of one central team owning one giant platform. Works at org scale; overkill for small teams. Full treatment: [Data Mesh](../../02_Databases/Data_Warehousing/03_Data_Mesh.md).
