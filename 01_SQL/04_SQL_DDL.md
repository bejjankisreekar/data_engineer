...
- **Partitioned tables** — one logical table, many physical chunks by range (e.g. by month): enables instant partition `SWITCH` loads and per-partition maintenance ([warehouse partitioning](../00_Fundamentals/02_OLAP_Storage.md)).
