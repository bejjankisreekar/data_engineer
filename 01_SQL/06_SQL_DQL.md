...
- `SELECT *` in production breaks contracts silently (new columns flow downstream), defeats [columnar pruning](../00_Fundamentals/02_OLAP_Storage.md), and inflates network/memory. Exploration only.
