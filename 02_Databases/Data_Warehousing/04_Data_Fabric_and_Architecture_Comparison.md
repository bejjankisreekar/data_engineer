...
| **Data Lake** | How do we store *any* raw data cheaply, before deciding its shape? | Centralized (usually) | [Data Lake vs Warehouse vs Database](../../04_Storage_and_Formats/Data_Storage/01_Data_Lake_vs_Warehouse_vs_Database.md) |
