...
- `DROP TABLE` in the lake deletes metadata; whether *files* die depends on managed vs external tables ([ADLS](../../04_Storage_and_Formats/Data_Storage/03_Azure_Data_Lake_Storage.md)) — know which you have before "cleaning up."
