...
The design question is always: *how stale is acceptable?* Dashboards tolerating 15-minute lag → materialize; regulatory "as-of-now" queries → don't. A materialized view is conceptually just a **precomputed aggregate table with a maintenance contract** — see also [OLAP summary tables](../../01_Foundations/Fundamentals/02_OLAP_Storage.md).
