...
Three levels of statistics — file, stripe, and **row group (every 10,000 rows)** — power predicate pushdown: `WHERE salary > 90000` skips any unit whose max < 90000. Same playbook as [Parquet's row groups/pages](05_Parquet.md) and the [zone maps idea](../00_Fundamentals/02_OLAP_Storage.md); ORC's finer-grained default indexing is its historical differentiator.
