...
- **Azure examples:** Azure SQL Database, [Azure Data Factory](../05_ETL_ELT/02_Azure_Data_Factory.md), Azure Databricks, Synapse, App Service, [ADLS](../04_Data_Storage/03_Azure_Data_Lake_Storage.md)
...
A typical Azure data platform is **almost entirely PaaS** — that's the sweet spot: you focus on pipelines and data, Microsoft runs the machinery. (It's also the Databricks pitch in [Why_Spark_Why_Databricks.md](../07_PySpark/Why_Spark_Why_Databricks.md): Spark-on-IaaS-you-manage vs Spark-as-a-platform.)
