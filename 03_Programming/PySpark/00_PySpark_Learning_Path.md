...
- Basic SQL ([01_SQL folder](../../02_Databases/SQL/01_What_is_SQL.md)) — PySpark constantly mirrors SQL concepts
- The [OLTP](../../01_Foundations/Fundamentals/01_OLTP_Storage.md)/[OLAP](../../01_Foundations/Fundamentals/02_OLAP_Storage.md) distinction helps everything make sense
