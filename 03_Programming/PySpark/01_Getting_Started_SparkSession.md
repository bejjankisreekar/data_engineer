...
- **Set the timezone explicitly** (`spark.sql.session.timeZone`) in every production job — timestamp bugs from inherited cluster timezones are endemic ([why](../../02_Databases/SQL/03_SQL_Data_Types.md)).
