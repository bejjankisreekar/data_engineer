...
This exact three-line shape is literally what [MapReduce](../../01_Foundations/Fundamentals/05_Hadoop_Architecture.md) automated, and it's why Spark's RDD API has "map" and "reduce" baked into its vocabulary — RDDs were Spark's answer to MapReduce, kept in memory instead of round-tripping to disk every stage.
