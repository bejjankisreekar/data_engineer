...
- **Predicate pushdown** — if you filter after reading a [Parquet](../../05_Storage_and_Formats/File_Formats/05_Parquet.md) file, Spark pushes the filter *into the read* and skips whole files/row-groups.
