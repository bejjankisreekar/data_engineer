...
- **Row-count / volume reconciliation** — expected vs. actual rows moved, logged every run and alerted on deviation ([the instrumentation habit](../../02_Databases/SQL/08_SQL_Aggregate_Functions.md)).
