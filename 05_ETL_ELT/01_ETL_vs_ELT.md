...
- **ELT**: use Data Factory purely to copy raw data into a [Data Lake](../04_Data_Storage/01_Data_Lake_vs_Warehouse_vs_Database.md) or Synapse, then run transformation queries inside Synapse itself.
...
Modern ELT on the lakehouse formalizes "load raw, refine in place" into layers with contracts ([ADLS zone layout](../04_Data_Storage/03_Azure_Data_Lake_Storage.md)):
...
- **PII/compliance**: mask/tokenize *before* the data lands anywhere broad-access ([GDPR pressure](../03_Cloud/01_Public_Private_Hybrid_Cloud.md)) — a T-before-L step by law, effectively "EtLT."
