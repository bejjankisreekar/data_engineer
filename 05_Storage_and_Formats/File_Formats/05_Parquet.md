...
- Row-group size trades pruning granularity vs metadata overhead; the ~128 MB default aligns with one [Spark task](../../03_Programming/PySpark/Spark_Processing.md) per row group.
