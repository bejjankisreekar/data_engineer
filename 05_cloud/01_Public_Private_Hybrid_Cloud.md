...
- Huge catalog of ready services (databases, [data lakes](../03_Data_Storage/03_Azure_Data_Lake_Storage.md), Databricks, AI)
...
- **Self-hosted Integration Runtime** — the data engineer's daily hybrid tool: a small agent installed *inside* the private network that lets [Data Factory](../04_ETL_ELT/02_Azure_Data_Factory.md) reach on-prem SQL Servers without opening inbound firewall holes (it dials *out*).
