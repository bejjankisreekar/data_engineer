...
- **Azure examples:** Azure SQL Database, [Azure Data Factory](../04_ETL_ELT/02_Azure_Data_Factory.md), Azure Databricks, Synapse, App Service, [ADLS](../03_Data_Storage/03_Azure_Data_Lake_Storage.md)
...
- "Serverless" ≠ "costless": pay-per-TB-scanned engines make an unpartitioned `SELECT *` a billing event ([OLAP gotchas](../00_Fundamentals/02_OLAP_Storage.md)).
