...
- **User-Defined Routes (UDR) + Azure Firewall / NVA** — force outbound traffic through a firewall for inspection and egress control (limits [data exfiltration](../../15_Cost_and_Performance/02_Storage_and_Query_Cost.md) and controls **egress** cost).
