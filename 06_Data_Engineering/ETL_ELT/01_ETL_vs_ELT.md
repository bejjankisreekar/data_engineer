...
- **Schema tests**: columns/types match contract (drift alert — [JSON drift](../../05_Storage_and_Formats/File_Formats/02_JSON.md)).
...
- **PII/compliance**: mask/tokenize *before* the data lands anywhere broad-access ([GDPR pressure](../../04_Cloud/Cloud_Concepts/01_Public_Private_Hybrid_Cloud.md)) — a T-before-L step by law, effectively "EtLT."
