...
- Column name hygiene: spaces/dots in names (common from Excel [CSVs](../../04_Storage_and_Formats/File_Formats/01_CSV.md)) break attribute access and complicate everything — `withColumnRenamed` or a cleanup loop over `df.columns` first thing after ingest.
