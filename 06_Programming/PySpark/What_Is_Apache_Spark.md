...
| Simple EL copy without transforms | [ADF](../../05_Data_Engineering/ETL_ELT/02_Azure_Data_Factory.md) copy activity |
...
- **Schema inference on JSON/CSV reads the data twice** and guesses badly at scale — always pass an explicit schema in production ([CSV](../../04_Storage_and_Formats/File_Formats/01_CSV.md), [JSON](../../04_Storage_and_Formats/File_Formats/02_JSON.md)).
