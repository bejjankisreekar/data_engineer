...
- **Nondeterministic UDFs** (random, time, API calls) can run more than once per row (retries, speculative execution) — mark `.asNondeterministic()` and design [idempotently](../04_ETL_ELT/ETL_vs_ELT.md).
