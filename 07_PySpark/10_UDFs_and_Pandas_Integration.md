...
- **Nondeterministic UDFs** (random, time, API calls) can run more than once per row (retries, speculative execution) — mark `.asNondeterministic()` and design [idempotently](../05_ETL_ELT/01_ETL_vs_ELT.md).
