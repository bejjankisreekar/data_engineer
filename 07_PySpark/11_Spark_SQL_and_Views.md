...
- **SQL shines**: multi-join business logic reviewed by SQL-fluent analysts, gold-layer transformations (this is dbt's whole thesis — [ELT's T](../05_ETL_ELT/01_ETL_vs_ELT.md)), ad-hoc exploration, anything a stakeholder must be able to read.
