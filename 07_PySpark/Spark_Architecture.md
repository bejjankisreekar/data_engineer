...
- Logs for a dead executor live on that node — centralize (cluster log delivery to [ADLS](../04_Data_Storage/03_Azure_Data_Lake_Storage.md)) or the evidence disappears with the VM.
