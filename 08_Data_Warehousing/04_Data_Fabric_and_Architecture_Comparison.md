...
| **Data Lake** | How do we store *any* raw data cheaply, before deciding its shape? | Centralized (usually) | [Data Lake vs Warehouse vs Database](../04_Data_Storage/01_Data_Lake_vs_Warehouse_vs_Database.md) |
| **Lakehouse** | How do we get warehouse guarantees (ACID, schema) at lake economics? | Centralized (usually) | [Big Data Evolution Timeline](../00_Fundamentals/06_Big_Data_Evolution_Timeline.md) |
