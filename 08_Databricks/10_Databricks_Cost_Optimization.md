...
A common cost win: spot workers + on-demand driver on nightly batch. This ties to [reliability](../12_Monitoring_and_Observability/03_Pipeline_Reliability.md) — spot is a cost/reliability trade.
...
- Use **incremental** pipelines so each run processes only new data ([dbt incremental](../13_dbt/02_Models_and_Refs.md), [Structured Streaming](../03_Programming/PySpark/13_Structured_Streaming.md)).
