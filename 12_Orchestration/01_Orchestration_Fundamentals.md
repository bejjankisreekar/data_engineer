...
Idempotency + a natural **partition/key per run** is what lets you retry and backfill without fear. It's the same principle from [CAP/streaming](../02_Databases/NoSQL/06_CAP_Theorem_and_Consistency.md) and [Project 1](../11_Projects/02_Project_1_Batch_Medallion_Pipeline.md).
