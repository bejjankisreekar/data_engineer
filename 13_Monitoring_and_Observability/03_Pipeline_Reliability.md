...
This is the single most important reliability property — and a recurring interview theme from [Orchestration](../12_Orchestration/01_Orchestration_Fundamentals.md) and [Project 1](../11_Projects/02_Project_1_Batch_Medallion_Pipeline.md).
...
- **Rerun from the point of failure** — orchestrators support repair/rerun-from-failed-task ([Workflows](../12_Orchestration/03_Databricks_Workflows.md)); design tasks so a partial run + rerun = a correct full run.
