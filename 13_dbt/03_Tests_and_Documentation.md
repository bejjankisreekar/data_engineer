...
This is the **freshness pillar** of [data observability](../12_Monitoring_and_Observability/04_Data_Observability.md), built into dbt.
...
Auto lineage is a genuine superpower: during an incident you instantly see a model's **upstream** cause and **downstream** blast radius ([observability](../12_Monitoring_and_Observability/04_Data_Observability.md)).
