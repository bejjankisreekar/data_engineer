...
- **Environment separation** so dev experiments don't run on prod-sized compute ([DataOps](../14_Testing_and_DataOps/04_DataOps_and_CICD_for_Data.md)).
...
- Cutting a cluster too small → jobs slow or fail (missing [freshness SLAs](../12_Monitoring_and_Observability/03_Pipeline_Reliability.md)).
