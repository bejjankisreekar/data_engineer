...
Spark auto-broadcasts tables under a threshold, but hinting `broadcast()` on a known-small dimension is a classic, high-impact win — exactly the customer/product dim joins from [Project 1](../18_Projects/02_Project_1_Batch_Medallion_Pipeline.md).
