...
Data contracts are a **2023+ hot topic** because the "shift-left" idea — catch data problems at the **source**, not three layers downstream — is how mature orgs stop playing whack-a-mole. They complement, not replace, [data quality testing](02_Data_Quality_Testing.md) and [observability](../13_Monitoring_and_Observability/04_Data_Observability.md): contracts **prevent** bad interfaces, quality tests **catch** bad values, observability **detects** anything that slips through. Mentioning contracts signals you're current with modern practice.
