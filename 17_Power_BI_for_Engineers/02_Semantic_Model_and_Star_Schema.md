...
- **DirectQuery** — when data is too big to import or must be real-time; you then care about *source* performance ([cost/performance](../16_Cost_and_Performance/00_Cost_and_Performance_Learning_Path.md)).
