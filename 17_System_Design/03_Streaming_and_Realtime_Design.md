...
### 2. Windowing & time
Aggregate over **windows** (tumbling/sliding/session) and choose **event time vs processing time**. Handle **late data** with **watermarks** that bound state ([Project 2](../18_Projects/03_Project_2_Streaming_Pipeline.md)).
