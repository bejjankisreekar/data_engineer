...
Point Power BI at the Gold Delta tables (via Databricks SQL Warehouse / serverless SQL). Build the star-schema model, mark the date table, and create measures. Covered in [Power BI for Engineers](../16_Power_BI_for_Engineers/00_Power_BI_Learning_Path.md). The dashboard: revenue trend, revenue by category/region, top customers.
