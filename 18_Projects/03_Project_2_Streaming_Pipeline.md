...
| Small stream but a huge cluster | Right-size / use a single-node or serverless for low volume ([Cost](../15_Cost_and_Performance/00_Cost_and_Performance_Learning_Path.md)) |
