...
```bash
cd 18_Projects/project_1_batch_medallion
...
| Local here | On Azure |
|---|---|
| `data/raw/<date>/*.csv` | ADLS Gen2 `raw-landing` container (see [ADLS](../../05_Storage_and_Formats/Data_Lakes_and_Storage/03_Azure_Data_Lake_Storage.md)) |
