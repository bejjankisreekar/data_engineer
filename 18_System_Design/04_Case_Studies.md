...
**3. Architecture:**
- **Ingest:** **Self-hosted Integration Runtime** + ADF to pull from on-prem SQL → ADLS ([ADF](../12_Orchestration/02_ADF_Orchestration.md)).
...
**5. Cross-cutting:** reconciliation testing (old vs new outputs — [audit-helper](../14_dbt/04_Snapshots_Seeds_Macros.md)), governance via Unity Catalog, cost via serverless/job clusters.
