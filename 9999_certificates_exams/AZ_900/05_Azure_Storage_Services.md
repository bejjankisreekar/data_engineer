...
For the full engineering-depth version of this topic (internals, ACLs, performance), see the main repo's [Azure Blob Storage](../../04_Data_Storage/02_Azure_Blob_Storage.md) and [Azure Data Lake Storage](../../04_Data_Storage/03_Azure_Data_Lake_Storage.md) notes. This file covers exactly what AZ-900 tests.
