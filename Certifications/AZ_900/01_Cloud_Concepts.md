...
More detail on this exact topic, including Azure's specific hybrid tools (Azure Arc, ExpressRoute, Azure Stack), lives in the main repo's [Public, Private & Hybrid Cloud](../../04_Cloud/Cloud_Concepts/01_Public_Private_Hybrid_Cloud.md) note if you want engineering-level depth beyond what AZ-900 requires.
