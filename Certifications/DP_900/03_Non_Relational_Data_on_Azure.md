...
|---|---|---|
| **Blob Storage** | Unstructured objects (files) in containers | Images, video, backups, data-lake files ([Blob](../../04_Storage_and_Formats/Data_Storage/02_Azure_Blob_Storage.md)) |
...
**Azure Data Lake Storage Gen2** = Blob Storage + a **hierarchical namespace**, optimized for big-data analytics ([ADLS](../../04_Storage_and_Formats/Data_Storage/03_Azure_Data_Lake_Storage.md)).
