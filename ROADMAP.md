...
- ✅ [**SQL by Example (input → output tables)**](02_Databases/SQL/16_SQL_Input_Output_Examples.md) — every operation, worked
- ✅ [**Functions Reference**](02_Databases/SQL/17_SQL_Functions_Reference.md) — all built-in functions + sargability
...
- ✅ [Python Learning Path](03_Programming/Python/00_Python_Learning_Path.md) — start here
- ✅ [Getting Started](03_Programming/Python/01_Getting_Started.md) → [Variables & Types](03_Programming/Python/02_Variables_and_Data_Types.md) → [Strings](03_Programming/Python/03_Strings.md)
- ✅ [Lists/Tuples/Sets](03_Programming/Python/04_Lists_Tuples_Sets.md) · [Dictionaries](03_Programming/Python/05_Dictionaries.md)
- ✅ [Conditionals & Loops](03_Programming/Python/06_Conditionals_and_Loops.md) · [Functions](03_Programming/Python/07_Functions.md) · [Comprehensions](03_Programming/Python/08_Comprehensions.md)
- ✅ [Files & Exceptions](03_Programming/Python/09_Files_and_Exceptions.md) · [Modules & venv](03_Programming/Python/10_Modules_and_Virtual_Environments.md)
- ✅ [Python for Data Engineering](03_Programming/Python/11_Python_for_Data_Engineering.md) — pandas + the bridge to Spark
- ✅ [Python Q&A](03_Programming/Python/Interview_Questions_and_Answers.md)
...
- ✅ [Public/Private/Hybrid Cloud](04_Cloud/Cloud_Concepts/01_Public_Private_Hybrid_Cloud.md) · [IaaS/PaaS/SaaS](04_Cloud/Cloud_Concepts/02_SaaS_PaaS_IaaS.md)
- ✅ [Cloud Concepts Q&A](04_Cloud/Cloud_Concepts/Interview_Questions_and_Answers.md)
...
- ✅ [What is Apache Spark?](03_Programming/PySpark/What_Is_Apache_Spark.md) · [Spark Architecture](03_Programming/PySpark/Spark_Architecture.md) · [Spark Processing](03_Programming/PySpark/Spark_Processing.md) · [Why Spark? Why Databricks?](08_Databricks/02_Why_Spark_Why_Databricks.md)

**The platform track — Databricks (do this alongside the coding track):**
- ✅ [Databricks module (08)](08_Databricks/00_Databricks_Learning_Path.md) — [What is Databricks](08_Databricks/01_What_is_Databricks.md) · [Why Spark/Databricks](08_Databricks/02_Why_Spark_Why_Databricks.md) · [Clusters](08_Databricks/03_Clusters_and_Compute.md) · [Notebooks/Jobs](08_Databricks/04_Notebooks_Repos_and_Jobs.md) · [Workflows](08_Databricks/05_Databricks_Workflows.md) · [Unity Catalog](08_Databricks/06_Unity_Catalog.md) · [ABFSS/Volumes](08_Databricks/07_Storage_Access_ABFSS_and_Volumes.md) · [DLT](08_Databricks/08_Delta_Live_Tables.md) · [Auto Loader](08_Databricks/09_Auto_Loader_and_Ingestion.md) · [Cost](08_Databricks/10_Databricks_Cost_Optimization.md)

**Coding track — read 00→15 in order:**
- ✅ [00 Learning Path](03_Programming/PySpark/00_PySpark_Learning_Path.md) → [01 SparkSession](03_Programming/PySpark/01_Getting_Started_SparkSession.md) → [02 DataFrames](03_Programming/PySpark/02_DataFrame_Basics.md) → [03 Schemas](03_Programming/PySpark/03_Schemas_and_Data_Types.md)
- ✅ [04 Read/Write](03_Programming/PySpark/04_Reading_and_Writing_Data.md) · [05 Columns](03_Programming/PySpark/05_Column_Operations_and_Functions.md) · [06 Aggregations](03_Programming/PySpark/06_Aggregations_and_Grouping.md) · [07 Joins](03_Programming/PySpark/07_Joins.md) · [08 Windows](03_Programming/PySpark/08_Window_Functions.md)
- ✅ [09 Complex Types/JSON](03_Programming/PySpark/09_Complex_Types_and_JSON.md) · [10 UDFs](03_Programming/PySpark/10_UDFs_and_Pandas_Integration.md) · [11 Spark SQL](03_Programming/PySpark/11_Spark_SQL_and_Views.md)
- ✅ [12 Delta Lake with PySpark](03_Programming/PySpark/12_Delta_Lake_with_PySpark.md) — **MERGE, time travel, OPTIMIZE**
- ✅ [13 Structured Streaming](03_Programming/PySpark/13_Structured_Streaming.md) · [14 Performance](03_Programming/PySpark/14_Performance_and_Best_Practices.md) · [15 RDDs](03_Programming/PySpark/15_RDDs_The_Foundation.md)
- ✅ [PySpark Q&A (78 questions)](03_Programming/PySpark/Interview_Questions_and_Answers.md) — the largest set in the repo

**Tie it together:** [Lakehouse Architecture + Medallion (Bronze/Silver/Gold)](05_Storage_and_Formats/Lakehouse/03_Lakehouse_Architecture.md)
...
- ✅ **ETL/ELT:** [ETL vs ELT](06_Data_Engineering/ETL_ELT/01_ETL_vs_ELT.md) · [Azure Data Factory](06_Data_Engineering/ETL_ELT/02_Azure_Data_Factory.md) · [Data Pipelines](06_Data_Engineering/ETL_ELT/03_Data_Pipelines.md)
- ✅ **Integration:** [Fundamentals](06_Data_Engineering/Data_Integration/01_Data_Integration_Fundamentals.md) · [Patterns](06_Data_Engineering/Data_Integration/02_Integration_Patterns.md) · [Change Data Capture](06_Data_Engineering/Data_Integration/03_Change_Data_Capture.md) · [Azure Integration Services](06_Data_Engineering/Data_Integration/04_Azure_Integration_Services.md)
- ✅ **Governance & Security:** [Data Governance & Security](06_Data_Engineering/Data_Governance/01_Data_Governance_and_Security.md) — RBAC, Key Vault, Purview, Unity Catalog, GDPR · [Network Security & Private Connectivity](06_Data_Engineering/Data_Governance/02_Network_Security_and_Private_Connectivity.md) — private endpoints, ADF Managed VNet, Databricks VNet injection · [Microsoft Entra ID](06_Data_Engineering/Data_Governance/03_Microsoft_Entra_ID.md) — managed identities, service principals, tokens, control-plane vs data-plane RBAC
- ✅ **Quality:** [Data Quality Fundamentals](06_Data_Engineering/Data_Quality/01_Data_Quality_Fundamentals.md) — expectations, quarantine, observability
- ✅ Q&A: [ETL/ELT](06_Data_Engineering/ETL_ELT/Interview_Questions_and_Answers.md) · [Integration](06_Data_Engineering/Data_Integration/Interview_Questions_and_Answers.md) · [Governance](06_Data_Engineering/Data_Governance/Interview_Questions_and_Answers.md) · [Quality](06_Data_Engineering/Data_Quality/Interview_Questions_and_Answers.md)

- ✅ **Streaming:** [Streaming module (09)](09_Streaming/00_Streaming_Learning_Path.md) — [Fundamentals](09_Streaming/01_Streaming_Fundamentals.md) · [Event Hubs](09_Streaming/02_Azure_Event_Hubs.md) · [Kafka](09_Streaming/03_Apache_Kafka.md) · [Stream Analytics](09_Streaming/04_Azure_Stream_Analytics.md) · [KQL & Real-Time Intelligence](09_Streaming/05_KQL_and_Real_Time_Intelligence.md)
...
- ✅ **Orchestration:** [Orchestration module (11)](11_Orchestration/00_Orchestration_Learning_Path.md) — DAGs, [ADF triggers](11_Orchestration/02_ADF_Orchestration.md), [Databricks Workflows](08_Databricks/05_Databricks_Workflows.md), [Apache Airflow](11_Orchestration/03_Apache_Airflow.md)
...
- ✅ **Cost & Performance:** [Cost module (15)](15_Cost_and_Performance/00_Cost_and_Performance_Learning_Path.md) — [FinOps](15_Cost_and_Performance/01_Cost_Fundamentals_FinOps.md), [Databricks cost](08_Databricks/10_Databricks_Cost_Optimization.md), [performance tuning](15_Cost_and_Performance/03_Performance_Optimization.md)
